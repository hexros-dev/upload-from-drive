...
if __name__ == "__main__":
    ...
    argparser.add_argument("--title", help="Video title", default="Test Title")  # type: ignore
    argparser.add_argument("--description", help="Video description", default="Test Description")  # type: ignore
    argparser.add_argument(  # type: ignore
        "--category",
        default="22",
